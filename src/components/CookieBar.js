...
const cookieName = 'docs-cookie-approval'
const ACCEPT = 'ACCEPT'
const REJECT = 'REJECT'
const cookieConfig = {
  expires: 365,
    ...
    >
      <div className="mx-auto max-w-screen-lg text-white flex items-center md:flex-row flex-col">
        <p className="text-sm md:mb-0 mb-6 md:text-left text-center">
          webrpc docs site uses cookies and similar technologies to provide you with
          personalized content, improve site performance, and conduct analytics.
          By using the webrpc docs site or other online services, you consent to
